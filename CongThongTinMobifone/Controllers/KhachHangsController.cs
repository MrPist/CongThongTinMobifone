...
namespace CongThongTinMobifone.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Number,Number_TypeID,PostCateID,Description,link")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Number,Number_TypeID,PostCateID,Description,link")] KhachHang khachHang)
        {
            if (id != khachHang.Number)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!KhachHangExists(khachHang.Number))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.KhachHang?.Any(e => e.Number == id)).GetValueOrDefault();
        }
    }
}
