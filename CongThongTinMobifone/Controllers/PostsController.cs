...
namespace CongThongTinMobifone.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostID,PostCateID,Post_title,Post_content,Date_created,Date_update,active")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PostID,PostCateID,Post_title,Post_content,Date_created,Date_update,active")] Post post)
        {
            if (id != post.PostID)
            {
                return NotFound();
